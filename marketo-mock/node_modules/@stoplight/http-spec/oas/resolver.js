...
function getComponentName(references, $ref) {
    var _a;
    return (_a = getResolved(references, $ref).match(/^#\/components\/([A-Za-z]+)\//)) === null || _a === void 0 ? void 0 : _a[1];
}
...
function getResolved(references, $ref) {
    const seen = new Set();
    let value = $ref;
...
function syncReferenceObject(target, references) {
    const { $ref } = target;
